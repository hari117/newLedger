                ...
                child: MaterialButton(
                  ...
                  onPressed: () async {
                    if (transcationAmountController.text == "" &&
                      ...
                      print(
                          "entered amount is ${transcationAmountController.text}");
                      Map<String, dynamic> map = {
                        "type": "Debit",
                        "amount": transcationAmountController.text,
                        "date": dateTime
                      };
                      print("******  map funtion finished**********");
                      await allTranscationRef
                          .doc(google.currentUser.id)
                          .collection(accoutNameController.text)
                          .doc()
                          .setData(map);
                      ...
                      DocumentSnapshot doc = await Firestore.instance
                          ...
                          .doc(accoutNameController.text)
                          .get();
                      int total = int.parse(transcationAmountController.text) +
                          doc["inDebit"];
                      print("total $total");
